...
task.spawn(function()
    ...
    -- Um أƒآ؛nico label centralizado na tela
    ...
    -- Entra vindo de cima (Y comeأƒآ§a em 0.3, vai pra 0.45)
    ...
    -- Digita tudo num أƒآ؛nico label: "Orksz Duels > Nine Duels"
    -- "Orksz Duels" em branco, " > Nine Duels" em cinza via cor أƒآ؛nica (sem RichText)
    local part1 = "â­گStar Hub"
    local part2 = " On Topâ­گ"
...
-- Sub-hubs: sem animacao, sأƒآ³ show/hide simples
...
local function _absorbNextClick()
    ...
    -- Seguranأƒآ§a: destroi apأƒآ³s 600ms caso nao venha clique falso
...
-- ============================================================
-- MAKEDRAG v3 - mobile-safe com absorأƒآ§أƒآ£o ativa de clique falso
-- ============================================================
...
do
    ...
    tpDownDot.Text = "ًںں£"; tpDownDot.ZIndex = 12
...
do
    ...
    MainFrame.InputBegan:Connect(function(i)
        ...
        -- Sأƒآ³ inicia drag se o toque for na area do header (acima do ContentArea)
...
-- أ¢â€‌â‚¬أ¢â€‌â‚¬ BARRA FPS/PING أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
...
-- أ¢â€‌â‚¬أ¢â€‌â‚¬ BARRA GRAB أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
...
-- Loop de atualizaأƒآ§أƒآ£o em tempo real (RenderStepped = todo frame)
...
-- ============================================================
-- أ¢â€‌â‚¬أ¢â€‌â‚¬ STEAL: funأƒآ§أƒآµes base (EGO style) أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
...
-- Retorna o animalData mais prأƒآ³ximo dentro do raio (para steal)
...
-- Retorna a posiأƒآ§أƒآ£o do alvo mais prأƒآ³ximo SEM limite (para look-at)
local function findNearestTarget()
    local _, bestD = nearestAnimal()  -- pega distأƒآ¢ncia do mais prأƒآ³ximo
    ...
    -- Retorna a BasePart do spawn se possأƒآ­vel, senأƒآ£o usa worldPosition
...
local function createDuelHub()
    ...
    local ladoEscolhido = nil  -- SEMPRE comeأƒآ§a nil (bloqueado), nunca salva lado

    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ FRAME PRINCIPAL أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    ...
    lblAuto.Text = "ًںں£"; lblAuto.ZIndex = 12
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ PAINEL (filho do duelGui, posicao sincronizada com fAuto) أ¢â€‌â‚¬
        ...
        RunService.Heartbeat:Connect(function(dt)
            ...
            if active then
                ...
                if hrp then
                    ...
                    -- Olha para o Brainrot mais proximo (sem limite de distأƒآ¢ncia)
    ...
    local function iniciarAutoPlay()
        ...
        -- Se ja tiver Brainrot na mao ao iniciar, comeأƒآ§a com AFTER STEAL
    ...
    local function pararAutoPlay()
        ...
        if heartbeatL then heartbeatL:Disconnect(); heartbeatL = nil end
        if heartbeatR then heartbeatR:Disconnect(); heartbeatR = nil end
        -- Sأƒآ³ restaura NOT STEALING se nao estiver roubando
        if mvSpeedOn and _bridgeSetMvSpeed and not lp:GetAttribute("Stealing") then _bridgeSetMvSpeed(duelNotStealSpeed) end
        atualizarBtnAutoVisual()
        local char = lp.Character
    ...
    autoTPDot.Text = "ًںں£"; autoTPDot.ZIndex = 12
    ...
    storeHubSize(fHitTP)
        ...
        hitTPDot.Text = "ًںں£"; hitTPDot.ZIndex = 12
...
-- ============================================================
-- MINI HUB DE POSIأƒâ€،أƒâ€¢ES - compacto, centro da tela
-- ============================================================
(function()
    ...
    posGui.Enabled = false  -- sأƒآ³ aparece quando o toggle ativa
    ...
    for i, key in ipairs(KEYS) do
        ...
        -- Botأƒآ£o SET (seta posiأƒآ§أƒآ£o atual)
...
(function()
    ...
    tBtn.MouseButton1Click:Connect(function()
        ...
        local msg = "ًں‘‘â­گStar Hub on topâ­گًں‘‘"
...
local function startFloat()
    -- Desconecta conexأƒآ£o anterior se existir (evita travar)
...
aimRedDot.Text = "ًںں£"; aimRedDot.TextColor3 = DOT_OFF
...
-- Divisor inline (gear abre frame que mostra sأƒآ³ keybind أ¢â‚¬â€‌ gerenciada pelo Settings)
...
local aimValueBox = Instance.new("TextBox", LockFrame) -- mantido pois أƒآ© upvalue usada em Settings
...
local function execSteal(prompt, animalName)
    ...
    task.spawn(function()
        -- Dispara holdCallbacks (inأƒآ­cio do hold)
        for _, fn in ipairs(data.holdCallbacks) do task.spawn(fn) end
        -- Espera a duraأƒآ§أƒآ£o configurأƒآ،vel
        local elapsed = 0
...
do
    ...
    maRedDot.Text = "ًںں£"; maRedDot.TextColor3 = DOT_OFF
...
-- ============================================================
-- ============================================================
-- AIM - mesmo sistema do AIM BAT + bat automأƒآ،tico contأƒآ­nuo
-- ============================================================
...
do
    ...
    startAbAim = function()
        ...
        abConnections.main = RunService.Heartbeat:Connect(function()
            ...
            -- Recria align se necessأƒآ،rio (respawn)
            ...
            -- Bat contأƒآ­nuo: usa ferramenta equipada no momento (permite trocar)
    ...
    -- Frame أ¢â‚¬â€‌ idأƒآھntico ao LockFrame
    ...
    abRedDot.Text = "ًںں£"; abRedDot.TextColor3 = DOT_OFF
    ...
    abGear.Text = "âڑ™ï¸ڈ"; abGear.BackgroundTransparency = 1
...
(function()
    ...
    floatRedDot.Text = "ًںں£"; floatRedDot.TextColor3 = DOT_OFF
    ...
    -- Hint power (valor editأƒآ،vel no Settings)
    ...
    -- Mantأƒآ©m a referencia de power vأƒآ،lida via _floatPowerRef (jأƒآ، setado antes)
    UIS.InputBegan:Connect(function(input, gp)
        if gp then return end
            ...
            autoFloatConn = RunService.Heartbeat:Connect(function()
                ...
                if close then
                    ...
                    if floatHubConn then
                        ...
                        -- mantأƒآ©m floatEnabled=true (dot aceso), mas fisica parada.
...
local function createSpeedHub()
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ DIVISOR أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ MOVEMENT SPEED أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    ...
    -- Toggle ENABLE أ¢â‚¬â€‌ alinhado igual ao SPEED de cima
    ...
    -- Bridge: para mvSpeed E atualiza visual (registrada apأƒآ³s mvKnob existir)
...
do
    ...
    _dbRedDot.BackgroundTransparency = 1; _dbRedDot.Text = "ًںں£"
...
ToggleSaved("Combat", "Hitbox Expander أ،آµâ€™أ،آµâ€“أ،آµâ€”أ¢آپآ±أ،آµâ€™أ¢آپآ؟أ،آµئ’أ‹آ،", "hitboxExp", true, function(v)
    hitboxActive = v
...
do
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ DUEL SPEEDS أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    makeSettingsTitle("أ¢â€“آ¸ DUEL SPEEDS")
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ AIM SPEEDS أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    makeSettingsTitle("أ¢â€“آ¸ AIM SPEEDS")
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ GRAB / STEAL أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    makeSettingsTitle("أ¢â€“آ¸ GRAB / STEAL")
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ SPIN أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    makeSettingsTitle("أ¢â€“آ¸ SPIN")
    ...
    -- أ¢â€‌â‚¬أ¢â€‌â‚¬ KEYBINDS أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬أ¢â€‌â‚¬
    makeSettingsTitle("أ¢â€“آ¸ KEYBINDS")
...
ToggleSaved("Desync", "Desync No Reset", "desyncNoReset", true, function(v)
    -- Lأƒآ³gica do Desync No Reset aqui
end);

ToggleSaved("Desync", "Desync Reset", "desyncReset", true, function(v)
    -- Lأƒآ³gica do Desync Reset aqui
end);
...
-- (intro removido - animacao sأƒآ³ no hub principal)
